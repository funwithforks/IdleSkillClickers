...
class IdleCV:
	...
	def screenshot(self, x1: int, y1: int, x2: int, y2: int) -> Union[ImageGrab.grab, None]:
	...
	def cropped_screenshot(self, image: ImageGrab.grab, l1, l2, h1, h2) -> ImageGrab.grab:
	...
	def image_find(self, background, image):
